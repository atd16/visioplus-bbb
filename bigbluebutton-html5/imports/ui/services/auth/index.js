...
class Auth {
  constructor() {
    ...
    this._externMeetingID = Storage.getItem('externMeetingID');
  ...
  set externMeetingID(externMeetingID) {
    this._externMeetingID = externMeetingID;
    Storage.setItem('externMeetingID', this._externMeetingID);
  }

  get externMeetingID() {
    return this._externMeetingID;
  }
  ...
  get credentials() {
    return {
      ...
      externMeetingID: this.externMeetingID,
  ...
  set(
    ...
    this.externMeetingID = externMeetingID;
